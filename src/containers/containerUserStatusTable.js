...
const mapStateToProp=state=>{
	...
	function outputObject(data,index){
		...
		var obj={
			...
			"bind_cathay":data.bind_cathay[index],
			"bind_fubon":data.bind_fubon[index],
			"bind_taishin":data.bind_taishin[index],
			"bind_hsbc":data.bind_hsbc[index],
			"bind_ctbc":data.bind_ctbc[index],
			"bind_hncb":data.bind_hncb[index],
			"bind_esun":data.bind_esun[index],
			"bind_dbs":data.bind_dbs[index],
			"bind_tcb":data.bind_tcb[index],
			"bind_tbb":data.bind_tbb[index],
